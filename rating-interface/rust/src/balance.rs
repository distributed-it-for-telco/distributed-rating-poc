...
impl BalanceAccessManager {
    ...
    pub async fn get_balance(&self,_ctx: &Context, customer_id: &str,offer_id: &str)-> RpcResult<Balance> {
    ...
    pub async fn withdraw(&self,_ctx: &Context, customer_id: &str,offer_id: &str,amount :f32) -> RpcResult<Balance> {
        ...
        self.put_to_store(_ctx, &balance_key, balance.clone()).await?;
