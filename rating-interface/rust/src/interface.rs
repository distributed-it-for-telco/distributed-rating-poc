...
pub struct Agent {
    pub identifiation: AgentIdentifiation,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub usage: Option<Usage>,
}

// Encode Agent as CBOR and append to output stream
#[doc(hidden)]
#[allow(unused_mut)]
pub fn encode_agent<W: wasmbus_rpc::cbor::Write>(
    ...
    <W as wasmbus_rpc::cbor::Write>::Error: std::fmt::Display,
{
    e.map(2)?;
    e.str("identifiation")?;
    encode_agent_identifiation(e, &val.identifiation)?;
...
// Decode Agent from cbor input stream
#[doc(hidden)]
pub fn decode_agent(d: &mut wasmbus_rpc::cbor::Decoder<'_>) -> Result<Agent, RpcError> {
    let __result = {
        let mut identifiation: Option<AgentIdentifiation> = None;
        let mut usage: Option<Option<Usage>> = Some(None);
        ...
        let is_array = match d.datatype()? {
            ...
            _ => {
                return Err(RpcError::Deser(
                    "decoding struct Agent, expected array or map".to_string(),
                ))
            }
        };
        if is_array {
            ...
            for __i in 0..(len as usize) {
                match __i {
                    0 => {
                        identifiation = Some(decode_agent_identifiation(d).map_err(|e| {
                            format!("decoding 'co.uk.orange.rating#AgentIdentifiation': {}", e)
                        })?)
                    }
                    1 => {
                        usage = if wasmbus_rpc::cbor::Type::Null == d.datatype()? {
                            ...
                            Some(Some(decode_usage(d).map_err(|e| {
                                format!("decoding 'co.uk.orange.rating#Usage': {}", e)
                            })?))
                        }
                    }
        ...
        Agent {
            identifiation: if let Some(__x) = identifiation {
                __x
            } else {
                return Err(RpcError::Deser(
                    "missing field Agent.identifiation (#0)".to_string(),
                ));
            },
            usage: usage.unwrap(),
        }
...
pub type AgentList = Vec<Agent>;

// Encode AgentList as CBOR and append to output stream
#[doc(hidden)]
#[allow(unused_mut)]
pub fn encode_agent_list<W: wasmbus_rpc::cbor::Write>(
    mut e: &mut wasmbus_rpc::cbor::Encoder<W>,
    val: &AgentList,
) -> RpcResult<()>
where
...
// Decode AgentList from cbor input stream
#[doc(hidden)]
pub fn decode_agent_list(d: &mut wasmbus_rpc::cbor::Decoder<'_>) -> Result<AgentList, RpcError> {
    let __result = {
        if let Some(n) = d.array()? {
            let mut arr: Vec<Agent> = Vec::with_capacity(n as usize);
            for _ in 0..(n as usize) {
                arr.push(
                    decode_agent(d)
                        .map_err(|e| format!("decoding 'co.uk.orange.rating#Agent': {}", e))?,
                )
            }
            arr
        } else {
            // indefinite array
            let mut arr: Vec<Agent> = Vec::new();
            loop {
                match d.datatype() {
                    Err(_) => break,
                    ...
                    0 => {
                        balance_characteristic =
                            Some(decode_balance_characteristic(d).map_err(|e| {
                                format!(
                                    "decoding 'co.uk.orange.rating#BalanceCharacteristic': {}",
                                    e
                                )
                            })?)
                    }
                ...
                match __i {
                    0 => {
                        messages = Some(decode_message_list(d).map_err(|e| {
                            format!("decoding 'co.uk.orange.rating#MessageList': {}", e)
                        })?)
                    }
                    ...
                    0 => {
                        bucket_characteristic =
                            Some(decode_bucket_characteristic(d).map_err(|e| {
                                format!(
                                    "decoding 'co.uk.orange.rating#BucketCharacteristic': {}",
                                    e
                                )
                            })?)
                    }
...
// Encode DeductBalance as CBOR and append to output stream
#[doc(hidden)]
#[allow(unused_mut)]
pub fn encode_deduct_balance<W: wasmbus_rpc::cbor::Write>(
    mut e: &mut wasmbus_rpc::cbor::Encoder<W>,
    val: &DeductBalance,
) -> RpcResult<()>
where
...
// Decode DeductBalance from cbor input stream
#[doc(hidden)]
pub fn decode_deduct_balance(
    d: &mut wasmbus_rpc::cbor::Decoder<'_>,
) -> Result<DeductBalance, RpcError> {
    let __result = {
        ...
        let is_array = match d.datatype()? {
            ...
            _ => {
                return Err(RpcError::Deser(
                    "decoding struct DeductBalance, expected array or map".to_string(),
                ))
            }
        };
        if is_array {
        ...
        DeductBalance {
            command_type: if let Some(__x) = command_type {
                ...
                return Err(RpcError::Deser(
                    "missing field DeductBalance.command_type (#0)".to_string(),
                ));
            },
            ...
            data: if let Some(__x) = data {
                ...
                return Err(RpcError::Deser(
                    "missing field DeductBalance.data (#1)".to_string(),
                ));
            },
...
pub struct GetChildrenRequest {
    #[serde(rename = "atomicOfferId")]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub atomic_offer_id: Option<String>,
    pub usage: Usage,
}

// Encode GetChildrenRequest as CBOR and append to output stream
#[doc(hidden)]
#[allow(unused_mut)]
pub fn encode_get_children_request<W: wasmbus_rpc::cbor::Write>(
    mut e: &mut wasmbus_rpc::cbor::Encoder<W>,
    val: &GetChildrenRequest,
) -> RpcResult<()>
where
    <W as wasmbus_rpc::cbor::Write>::Error: std::fmt::Display,
{
    e.map(2)?;
    if let Some(val) = val.atomic_offer_id.as_ref() {
        e.str("atomicOfferId")?;
        e.str(val)?;
    } else {
        e.null()?;
...
// Decode GetChildrenRequest from cbor input stream
#[doc(hidden)]
pub fn decode_get_children_request(
    d: &mut wasmbus_rpc::cbor::Decoder<'_>,
) -> Result<GetChildrenRequest, RpcError> {
    let __result =
        {
            let mut atomic_offer_id: Option<Option<String>> = Some(None);
            ...
            let is_array = match d.datatype()? {
                ...
                _ => {
                    return Err(RpcError::Deser(
                        "decoding struct GetChildrenRequest, expected array or map".to_string(),
                    ))
                }
            };
            if is_array {
                ...
                for __i in 0..(len as usize) {
                    match __i {
                        0 => {
                            atomic_offer_id = if wasmbus_rpc::cbor::Type::Null == d.datatype()? {
                                d.skip()?;
                                Some(None)
                            } else {
                                Some(Some(d.str()?.to_string()))
            ...
            GetChildrenRequest {
                atomic_offer_id: atomic_offer_id.unwrap(),

                usage: if let Some(__x) = usage {
                    __x
                } else {
                    return Err(RpcError::Deser(
                        "missing field GetChildrenRequest.usage (#1)".to_string(),
                    ));
                },
            }
        };
            ...
            if let Some(n) = d.array()? {
                ...
                for _ in 0..(n as usize) {
                    arr.push(decode_offer_details(d).map_err(|e| {
                        format!("decoding 'co.uk.orange.rating#OfferDetails': {}", e)
                    })?)
                }
                arr
            } else {
            ...
            if let Some(n) = d.array()? {
                ...
                for _ in 0..(n as usize) {
                    arr.push(decode_rating_record(d).map_err(|e| {
                        format!("decoding 'co.uk.orange.rating#RatingRecord': {}", e)
                    })?)
                }
                arr
            } else {
                    ...
                    0 => {
                        headers = if wasmbus_rpc::cbor::Type::Null == d.datatype()? {
                            ...
                            Some(Some(decode_headers_map(d).map_err(|e| {
                                format!("decoding 'co.uk.orange.rating#HeadersMap': {}", e)
                            })?))
                        }
                    }
                    1 => {
                        rating_request = Some(decode_rating_request(d).map_err(|e| {
                            format!("decoding 'co.uk.orange.rating#RatingRequest': {}", e)
                        })?)
                    }
                    _ => d.skip()?,
                }
                        ...
                        4 => {
                            rating_history = if wasmbus_rpc::cbor::Type::Null == d.datatype()? {
                                ...
                                Some(Some(decode_rating_history(d).map_err(|e| {
                                    format!("decoding 'co.uk.orange.rating#RatingHistory': {}", e)
                                })?))
                            }
                        }
                        5 => {
                    ...
                    0 => {
                        authorization_status =
                            Some(decode_authorization_status(d).map_err(|e| {
                                format!("decoding 'co.uk.orange.rating#AuthorizationStatus': {}", e)
                            })?)
                    }
                    1 => {
                        billing_information = Some(decode_billing_information(d).map_err(|e| {
                            format!("decoding 'co.uk.orange.rating#BillingInformation': {}", e)
                        })?)
                    }
                    2 => {
                    ...
                    match __i {
                        0 => usage_characteristic_list =
                            Some(decode_usage_characteristic_list(d).map_err(|e| {
                                format!(
                                    "decoding 'co.uk.orange.rating#UsageCharacteristicList': {}",
                                    e
                                )
                            })?),
                        _ => d.skip()?,
        ...
        if let Some(n) = d.array()? {
            ...
            for _ in 0..(n as usize) {
                arr.push(decode_usage_characteristic(d).map_err(|e| {
                    format!("decoding 'co.uk.orange.rating#UsageCharacteristic': {}", e)
                })?)
            }
            arr
        } else {
        ...
        if let Some(n) = d.array()? {
            ...
            for _ in 0..(n as usize) {
                arr.push(decode_usage_proof_details(d).map_err(|e| {
                    format!("decoding 'co.uk.orange.rating#UsageProofDetails': {}", e)
                })?)
            }
            arr
        } else {
    ...
    let __result =
        {
            ...
            UsageProofRequest {
                ...
                usage_characteristic_list: if let Some(__x) = usage_characteristic_list {
                    ...
                    return Err(RpcError::Deser(
                        "missing field UsageProofRequest.usage_characteristic_list (#5)"
                            .to_string(),
                    ));
                },
    ...
    let __result = {
        ...
        ValidationResponse {
            valid: if let Some(__x) = valid {
                ...
                return Err(RpcError::Deser(
                    "missing field ValidationResponse.valid (#0)".to_string(),
                ));
            },
        }
    };
...
pub trait RatingAgentReceiver: MessageDispatch + RatingAgent {
    async fn dispatch(&self, ctx: &Context, message: Message<'_>) -> Result<Vec<u8>, RpcError> {
        match message.method {
            ...
            "GetChildren" => {
                let value: GetChildrenRequest = wasmbus_rpc::common::deserialize(&message.arg)
                    .map_err(|e| RpcError::Deser(format!("'GetChildrenRequest': {}", e)))?;

                let resp = RatingAgent::get_children(self, ctx, &value).await?;
                let buf = wasmbus_rpc::common::serialize(&resp)?;
    ...
    async fn get_children(&self, ctx: &Context, arg: &GetChildrenRequest) -> RpcResult<AgentList> {
        ...
        let resp = self
            ...
            .send(
                ctx,
                Message {
                    method: "RatingAgent.GetChildren",
                    arg: Cow::Borrowed(&buf),
                },
                None,
            )
        ...
        let value: AgentList = wasmbus_rpc::common::deserialize(&resp)
            .map_err(|e| RpcError::Deser(format!("'{}': AgentList", e)))?;
        Ok(value)
    }
}
