...
struct DropBoxUsageCollector;

const USAGE_LIST_KEY: &str = "rating:usage:dropbox";

impl Guest for DropBoxUsageCollector {
    fn store(arg: String) {
        log(wasi::logging::logging::Level::Info, "", &"DropBox Usage Collector".to_string());
